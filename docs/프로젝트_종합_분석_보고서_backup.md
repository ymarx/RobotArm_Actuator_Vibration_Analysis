...
- **결과**: 684개 윈도우 생성 (정확한 분포는 데이터셋 참조)
...
Val:   2023-07-01 ~ 2023-08-31
Test:  2023-09-01 ~ 2023-12-31
```

**분할 근거**:
- **시간 순서 유지**: 미래 데이터 예측 현실 반영
- **데이터 누수 방지**: 같은 파일의 윈도우가 여러 세트에 분산되지 않음
- **일반화 성능 평가**: Test 세트가 실제 운영 환경 시뮬레이션

**최종 분포**:
| 데이터셋 | 윈도우 수 | Normal | Abnormal | 파일 수 |
|---------|----------|--------|----------|---------|
| **Train** | 476 | 155 | 321 | ~35 |
| **Validation** | 92 | 4 | 88 | ~10 |
| **Test** | 111 | 14 | 97 | ~12 |
...
**알려진 제약**:
- ⚠️ Normal 데이터 부족 (Train 155개, Test 14개)
...
- 작성일: 2025-11-19
- 프로젝트 기간: 2025-11-17 ~ 2025-11-19
- 최종 모델 위치: `claudedocs/phase3_results/phase3_1_xgboost_core/xgboost_v3_core_band_rms.json`
- 참고 문서: `claudedocs/SESSION_SUMMARY_Phase3.md`

---

**부록**:
- Phase 1 EDA: `claudedocs/phase1_eda/`
- Phase 2 결과: `claudedocs/phase2_results/`
- Phase 3 결과: `claudedocs/phase3_results/`
- 실험 스크립트: `phase1/`, `phase2/`, `phase3/`
